...
export default function Footer(){
  return (
    <footer id="footer" className="mt-12 bg-deep-charcoal border-t border-muted-slate anim-fade-up" data-animate>
      <div className="max-w-7xl mx-auto px-4 py-8 text-center text-silver-mist">
        ...
        <div className="mt-3 flex items-center justify-center gap-4">
          <a className="text-soft-ivory hover:text-silver-mist btn-animated" href="/resume.pdf" target="_blank" rel="noreferrer">Download resume</a>
