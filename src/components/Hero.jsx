      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-10">
        <div className="flex-1 text-left lg:text-left">
          ...
          <div className="mt-6 flex gap-3">
            <a className="inline-flex items-center gap-2 px-4 py-2 bg-shadow-grey text-soft-ivory rounded-lg font-semibold" href="#projects">View projects →</a>
            <a className="inline-flex items-center gap-2 px-4 py-2 border border-muted-slate text-silver-mist rounded-lg" href="#about">About me</a>
          </div>
        </div>
